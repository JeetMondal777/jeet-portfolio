  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-18 h-18 rounded-full bg-gradient-to-br from-primary via-primary-dim to-tertiary-container animate-pulse flex items-center justify-center z-10">
            ...
            ></div>
            <Image
              className="w-18 h-18 pt-1 rounded-full object-cover ring-2 ring-primary/30"
              src={me}
              alt="Profile"
              width={100}
              height={100}
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-24 left-1/2 -translate-x-1/2 w-64 bg-surface-container/95 backdrop-blur-lg border-outline-variant/30 shadow-xl shadow-primary/10 overflow-visible">
